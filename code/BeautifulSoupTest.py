...
print("--soup.title의 결과: ", soup.title)
...
print("--soup.body.p는 첫번째 paragraph 출력, 그다음 paragraph는: ",p2)
print("--soup.body.p는 첫번째 paragraph 출력, 그다음 paragraph는: ",p2.string)
...
print("--soup.find()의 결과: ", soup.find('a'))
...
[옵션]
Limit - 몇 개까지 찾을것인가? find_all()로 검색하였을 때, 수천수만개가 된다면 시간이 오래 걸릴 것이다.
이때 몇개까지만 찾을 수 있도록 제한을 둘 수 있는 인자다.
